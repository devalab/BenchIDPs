...
{
	inFile.open("../uniqID_shell_hp36_c36i_disp_nojump_300k_1ps_1_3angs.dat");
	FILE* inFileAllId;
	inFileAllId = fopen("../uniqID_allwat_hp36_c36i_disp_nojump_300k_1ps_1_3angs.dat" , "r");
	inFileX.open("../input_OxyMx_hp36_c36i_disp_nojump_300k_1ps_1_3angs.dat");
	inFileY.open("../input_OxyMy_hp36_c36i_disp_nojump_300k_1ps_1_3angs.dat");
	inFileZ.open("../input_OxyMz_hp36_c36i_disp_nojump_300k_1ps_1_3angs.dat");	
